...
<div class="container" style=" min-height: 75vh;display: flex; flex-direction: column;">
    ...
    <div class="row" id="myItems">
        <div class="wrap d-flex flex-wrap justify-content-start">
            <div class="box one m-2" onclick="window.location.href='{{ route('supplies.index') }}';">
                <h1>Todo</h1>
                <div class="poster">
            ...
            <div class="box one m-2" onclick="window.location.href='{{ route('supplies.index', ['category_id' => $categoria->id]) }}';">
