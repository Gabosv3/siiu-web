...
<div class="container row mb-3">
    <div class="col-sm-12 text-end">
        <a href="{{ route('procesar.index') }}" class="btn btn-secondary">Volver a  Barcode</a>
    </div>
</div>
            ...
            <div class="card shadow-sm boxx">
                <div class="card-header text-center d-flex flex-column justify-content-center align-items-center">
                    <div class="card-icon mb-3">
                        @if($hardware->category && $hardware->category->image)
    ...
    <div class="mt-auto">
        <div class="row d-flex justify-content-between align-items-center mt-3">
            <div class="col-lg-10 sm-12 text-left">
                Mostrando registros del {{ $hardwareItems->firstItem() }} al {{ $hardwareItems->lastItem() }} de un total de {{ $hardwareItems->total() }} registros
            </div>
            @if($hardwareItems->total() > $hardwareItems->perPage())
