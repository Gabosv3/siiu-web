...
@section('content')
    ...
    <div class=" p-3" style="min-height: 80vh;">
                ...
                <div class="col d-flex">
                    <div class="card p-3 text-center flex-grow-1 d-flex flex-column align-items-center justify-content-center"
                        ...
                        <p class="m-0 text-uppercase text-secondary">
                            {{ $hardware->hardwareAssigned->user->name ?? 'No asignado' }}</p>
                ...
                <div class="col d-flex">
                    <div class="card p-3 text-center flex-grow-1 d-flex flex-column align-items-center justify-content-center"
                        ...
                        <p class="m-0 text-secondary">
                            {{ $hardware->hardwareAssigned->user->departament->name ?? 'No Ubicado' }}</p>
                    </div>
                </div>
                <!-- Estado -->
                <div class="col d-flex">
        ...
        <div class="modal fade" id="linkLicenseModal" tabindex="-1" aria-labelledby="linkLicenseModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="linkLicenseForm">
                        <div class="modal-header">
                                ...
                                <select id="licenseSelect" class="form-select" name="license_id">
                                    @foreach ($availableLicenses as $license)
                                        <option value="{{ $license->id }}">
                                            {{ $license->license_key }} - Disponibles: {{ $license->max_devices }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
