                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @elseif(!$data['user']->loginSecurity->google2fa_enable)
                            1. Escanea este código QR con tu aplicación Google Authenticator. Alternativamente, puedes usar el código: <code>{{ $data['secret'] }}</code><br/>                            <img src="data:image/svg+xml;base64,{{ base64_encode($data['google2fa_url']) }}" alt="Código QR">
                            <br/><br/>
