...
// Si el segmento es un número (potencial id), omítelo
if (is_numeric($segment)) {
continue; // Salta al siguiente segmento sin añadir nada
}
        ...
        <ul class="navbar-nav  justify-content-end ">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a title="Editar Perfil" href="{{ route('user.one_edit', Auth::user()->id) }}" class="dropdown-item" id="btn-oneedit-module">
