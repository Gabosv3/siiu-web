        ...
        <div class="col-md-6">
            <form action="{{ route('departamentos.update', $departamento->id) }}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="input-nombre-departamento" name="nombre" value="{{ $departamento->nombre }}" pattern="[A-Za-záéíóúÁÉÍÓÚñÑ\s]+" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="input-codigo-departamento" name="codigo" value="{{ $departamento->codigo }}" pattern="\d+" required>
                    <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control js-example-basic-single" id="input-encargado-departamento" name="encargado" data-show-subtext="true" data-live-search="true">
                        ...
                        <option value="{{ $user->id }}" {{ $user->informacionPersonal->nombres . ' ' . $user->informacionPersonal->apellidos  == $departamento->encargado ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="input-descripcion-departamento" name="descripcion" rows="3">{{ $departamento->descripcion }}</textarea>
                </div>

                <!-- Campo para ingresar la latitud -->
                <div class="mb-3">
                    <input type="text" id="latitude" name="latitude" value="{{ $departamento->latitude }}" placeholder="Latitud" class="form-control" readonly>
                </div>

                <!-- Campo para ingresar la longitud -->
                <div class="mb-3">
                    <input type="text" id="longitude" name="longitude" value="{{ $departamento->longitude }}" placeholder="Longitud" class="form-control" readonly>
                </div>


                <!-- Botón para actualizar el departamento -->
