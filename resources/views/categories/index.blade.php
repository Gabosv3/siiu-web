                        ...
                        @else
                            ...
                            <td>
                                @if ($category->image)
                                    ...
                                    <img src="{{ asset($category->image) }}" alt="Category {{ $category->name }}"
                                        class="img-thumbnail" style="height: 72px;">
                                @else
                            ...
                            <td>
                                @can('categorias.index')
                                    <a href="{{ route('categories.show', $category->id) }}" title="Ver Categoría"
                                        class="btn btn-cyan-800">
                                        <i class="bx bxs-show"></i>
                                    </a>
                                @endcan
                                @can('categorias.edit')
                                    <a href="{{ route('categories.edit', $category->id) }}" title="Editar Categoría"
