...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (departments && Array.isArray(departments) && departments[0] && departments[0].data && Array.isArray(departments[0].data)) {
            departments[0].data.forEach(function(department) {
                console.log("Datos del departamento:", department);

                let lat = parseFloat(department.latitude);
                let lng = parseFloat(department.longitude);
            ...
            console.error("⚠ Error: La estructura de datos no es válida", departments);
        }
